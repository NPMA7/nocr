...
export default function ActivityLogList({ logs = [], isConnected = false }) {
  const getLogStyle = (msg) => {
    if (!msg)
      return {
        bgColor: "bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-500/20 text-slate-800 dark:text-slate-200",
    ...
    if (lowercaseMsg.includes("berhasil") || lowercaseMsg.includes("online")) {
      return {
        bgColor: "bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-500/20 text-slate-800 dark:text-slate-200",
    ...
    if (
      ...
      return {
        bgColor: "bg-rose-50 dark:bg-rose-950/20 border-rose-200 dark:border-rose-500/20 text-slate-800 dark:text-slate-200",
    ...
    if (
      ...
      return {
        bgColor: "bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-500/20 text-slate-800 dark:text-slate-200",
  ...
  return (
    <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700/50 rounded-xl p-4 md:p-5 flex flex-col h-full min-h-0">
