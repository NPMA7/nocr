  ...
  const handleSave = async () => {
    ...
    try {
      const res = await axios.patch(`/api/sites/${encodeURIComponent(mac)}`, {
        ...
        pics,
        connection_type: "pppoe", // PPPoE for OPD
      });
      setData(res.data);
      applyForm(res.data);
  ...
  if (error && !data) {
    return (
      <div className="flex flex-col items-center justify-center h-full gap-4 text-red-400 p-8">
        ...
        >
          <ArrowLeft size={14} /> Kembali ke daftar OPD
        </Link>
      </div>
    );
  }
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              <h1 className="text-sm sm:text-base font-bold text-slate-100 truncate">
                {data?.prefix || "Detail Wilayah OPD"}
              </h1>
              <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold tag-opd">
                OPD
              </span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div className="p-3 bg-slate-900 border border-slate-800 rounded-xl shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] font-mono px-1.5 py-0.2 rounded font-bold tag-opd">
              OPD
            </span>
          </div>
            ...
            <div className="flex flex-col gap-3 pt-4">
              <div>
                ...
                <input
                  ...
                  disabled={!canEdit}
                  placeholder="Contoh: MILENETWORK (BABBAGE)"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    disabled={!canEdit}
                    placeholder="Contoh: 1388317 atau PLG-01"
            ...
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 mt-0.5">
                    Kontak teknisi atau penanggung jawab operasional di lokasi OPD
                  </p>
                </div>
              </div>
