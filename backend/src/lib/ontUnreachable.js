/**
 * Template Halaman Diagnostik Saat Web ONT OPD Tidak Dapat Dihubungi / Timeout
 * Digunakan oleh reverse proxy ONT di server.js
 */

function renderOntUnreachableHtml(ip, port = 80, detail = '') {
    return `<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="utf-8">
    ...
    <div class="card">
        ...
        <div class="info-box">
            ...
            <div class="info-row">
                ...
                <span class="info-val" style="color:#f87171;">${port} (TCP)</span>
            </div>
            <div class="info-row">
                <span class="info-label">Diagnosa Sistem</span>
                <span class="info-val" style="color:#fbbf24;">WAN Remote Management Nonaktif</span>
            </div>
